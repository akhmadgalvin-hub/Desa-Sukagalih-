...
const SukagalihApp = {
  ...
  renderHomepage() {
    ...
    return `
      <!-- HERO SECTION WITH INDONESIAN BATIK MOTIF -->
      <section class="hero-section">
        <div class="container">
          <div class="hero-content">
            <div class="hero-badge">
              <span>🇮🇩</span> Portal Desa Nusantara • ⛅ 24°C Kaki Galunggung, Tasikmalaya
            </div>
            <h1 class="hero-title">
              Sampurasun! Wilujeng Sumping di<br>
              <span class="hero-title-highlight">Desa Sukagalih</span>
            </h1>
            <p class="hero-subtitle">
              <em>"Gemah Ripah Loh Jinawi di Bawah Naungan Gunung Galunggung."</em><br>
              ${hero.shortDesc}
            </p>
            <div class="hero-actions">
              <a href="#/potensi" class="btn btn-primary btn-lg">🌾 Jelajahi Potensi Desa →</a>
              <a href="#/umkm" class="btn btn-secondary btn-lg">🛍️ Produk Lokal UMKM</a>
              <a href="#/profil" class="btn btn-outline-white btn-lg">🏛️ Profil & Sejarah</a>
            </div>
          </div>
        </div>
      </section>
